...
public class Controller {
    ...
    public void initBinder(WebDataBinder binder) {
        binder.registerCustomEditor(Time.class, "uhrzeit", new PropertyEditorSupport() {
            @Override
    ...
    public String halloWelt(Model model) {
        ...
        // Erledigt TODO: Aufgabe 4b) Rufe die Methode auf zur Erstellung einer Liste aller Kunden und
    ...
    public String getFilme(Model model,
        ...
        if ((genre != null && !genre.isEmpty()) && (titel != null && !titel.isEmpty())) {
            ...
            // Erledigt TODO: Aufgabe 4a: Rufe die Methode getFilmeByTitel in einer weiteren else if Anweisung auf
    ...
    public String getVorstellungen(Model model,
        ...
        List<VorstellungDTO> vorstellungen;
    ...
    public String addVorstellung(@ModelAttribute("vorstellung") VorstellungDTO vorstellung, Model model) {
        //Erledigt TODO: Aufgabe 4e (return muss auch angepasst werden)
    ...
    public String getTickets(Model model, @RequestParam(required = false) String email) {
        ...
        if (email != null && !email.isEmpty()) {
            if (kundeDao.checkEmailExists(email)) {
