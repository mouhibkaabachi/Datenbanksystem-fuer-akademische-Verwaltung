...
public class KundeDao {
    ...
    public List<KundeDTO> getAllKunden() {
        // Erledigt TODO: Aufgabe 4b) gib alle Kunden zurueck
    ...
    public void updatePassword(String email, String newPasswort) {
        // Erledigt TODO: Aufgabe 4g)
        String sql = "UPDATE kunde SET email = ? WHERE passwort = ?";
        jdbcTemplate.update(sql, email, newPasswort);
    }
